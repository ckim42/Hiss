...
class GameScene: SKScene {
    ...
    func initializeGameView() {
        ...
        currentScore.fontColor = SKColor.gray
    ...
    func startGame() {
        ...
        let bottomCorner = CGPoint(x: 0, y: (frame.size.height / -2))
    ...
    func makeApple() {
        ...
        let randomX = CGFloat(Int.random(in: 50 ... Int(view.bounds.width - 50)))
        let randomSpeed = Double(Int.random(in: 1 ... 4))
        let apple = Apple()
    }
    
    func initializeMenu() {
        gameLogo = SKLabelNode(fontNamed: "Helvetica")
        ...
        bestScore = SKLabelNode(fontNamed: "Helvetica")
